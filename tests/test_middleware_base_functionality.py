...
#
# copied verbatim from django/tests/redirects_tests/tests.py to ensure nothing
# changed in this middleware affects reverse-compatibility with expected
# behaviors for users moving from base implementation
#
# only change in this file from the original is the name of the middleware set
# in @modify_settings
#
...
@modify_settings(MIDDLEWARE={'append': 'tests.test_middleware_base_functionality.OverriddenRedirectFallbackMiddleware'})
